...
public final class ImpactAnalysisAnalyzerWrapper extends DelegatingAnalyzerWrapper {
    ...
    private static final String RESOURCE_REF_FIELD_NAME_BEGIN = "properties." + ReferenceIndexTerm.TERM + ":";
    private static final String SHARED_PART_REF_FIELD_NAME_BEGIN = "properties." + SharedPartIndexTerm.TERM + ":";
    private static final String PACKAGE_NAME_FIELD_NAME = "properties." + PackageNameIndexTerm.TERM;
    private static final String PROJECT_NAME_FIELD_NAME = "properties." + ProjectNameIndexTerm.TERM;
    private static final String PROJECT_ROOT_PATH_FIELD_NAME = "properties." + ProjectRootPathIndexTerm.TERM;
    ...
    static {
        ...
        for (int i = 0; i < partTypes.length; ++i) {
            PART_FIELD_NAME_BEGINS[i] = "properties." + partTypes[i].toString() + ":";
        }
    }
    ...
    static {
        ...
        for (int i = 0; i < resTypes.length; ++i) {
            RESOURCE_FIELD_NAME_BEGINS[i] = "properties." + resTypes[i].toString() + ":";
        }
    }
