...
public class ExamplesServiceImpl extends BaseProjectImportService implements ExamplesService {
    ...
    private String md5;
    private File playgroundRootDirectory;
    //    private OrganizationalUnit playgroundSpace;
    private ExampleRepository playgroundRepository;
    private String playgroundSpaceName;
    ...
    protected void deleteOldHiddenSpaces(String md5) {
        this.ouService.getAllOrganizationalUnits(false, (ou) -> ou.getName().startsWith(PREFIX) && !ou.getName().endsWith(md5))
    ...
    protected void createPlaygroundHiddenSpace(String md5) {
        ...
        String defaultGroupId = "org.kie.playground";
        this.ouService.createOrganizationalUnit(spaceName, defaultGroupId);
    }
...
//    }
    ...
    private boolean existSpace(String space) {
        try {
