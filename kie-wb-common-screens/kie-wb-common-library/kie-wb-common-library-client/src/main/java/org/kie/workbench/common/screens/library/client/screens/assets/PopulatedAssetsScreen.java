...
public class PopulatedAssetsScreen {
    ...
    protected boolean canUpdateProject() {
        return this.projectController.canUpdateProject(this.projectInfo.getProject());
    }
    ...
    protected ProjectAssetsQuery createProjectQuery(String filter,
        ...
        return new ProjectAssetsQuery(libraryPlaces.getProjectInfo().getProject(),
                                      filter,
                                      startIndex,
                                      amount,
                                      suffixes);
    ...
    private boolean isProjectNull() {
        return this.libraryPlaces.getProjectInfo() == null || this.libraryPlaces.getProjectInfo().getProject() == null;
    }
