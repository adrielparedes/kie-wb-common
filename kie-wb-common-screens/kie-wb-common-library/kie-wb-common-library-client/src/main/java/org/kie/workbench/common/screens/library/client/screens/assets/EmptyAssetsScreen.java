...
public class EmptyAssetsScreen {
    ...
    protected boolean canUpdateProject() {
        return this.projectController.canUpdateProject(this.libraryPlaces.getProjectInfo().getProject());
    }

    public void addAsset() {
        if (this.canUpdateProject()) {
            this.libraryPlaces.goToAddAsset(this.libraryPlaces.getProjectInfo());
        }
    }
